...
In addition to the FV simulator, **PyAFV** includes a :py:class:`pyafv.calibrate.DeformablePolygonSimulator` class for simulating the DP model, which can be used for calibration as well as standalone analyses.
