...
def target_delta(params: PhysicalParams, target_force: float) -> float:
    ...
    .. note::
        We search for the cell-cell distance at which the intercellular force (last one) matches the target force, from :math:`10^{-6}\ell` to :math:`(2-10^{-6})\ell` with a step :math:`10^{-6}\ell`.
    """
