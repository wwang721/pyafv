...
[![codecov](https://codecov.io/github/wwang721/py-afv/graph/badge.svg?token=VSXSOX8HVS&branch=feature)](https://codecov.io/github/wwang721/py-afv?branch=feature)
...
> **Note:** The current version requires **Cython** (and therefore a working C/C++ compiler).
For a pure-Python implementation with no C/C++ compiled dependencies, see **[v0.1.0](https://github.com/wwang721/py-afv/releases/tag/v0.1.0)**.
